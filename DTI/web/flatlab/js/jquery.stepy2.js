	...
	var methods = {
		init: function(options) {
			return this.each(function() {
				...
				var $titlesWrapper = $('<ul/>', { id: id + '-titles-2', 'class': 'stepy-titles-2 clearfix' });
		        ...
		        var $finish = $this.children('.finish-2');
		        ...
		        $steps.delegate('input[type="text"], input[type="password"]', 'keypress', function(evt) {
		        	...
		        	if (key == 13) {
		        		...
		        		if ($buttons.length) {
		        			var $next = $buttons.children('.button-next-2');

		        			if ($next.length) {
		        				$next.click();
		        			} else {
			        			var $finish = $buttons.children('.finish-2');
        	...
        	$('<a/>', { id: id + '-back-' + index, href: 'javascript:void(0);', 'class': 'button-back-2 btn btn-info', html: opt.backLabel }).click(function() {
        	...
        	$('<a/>', { id: id + '-next-' + index, href: 'javascript:void(0);', 'class': 'button-next-2  btn btn-info', html: opt.nextLabel }).click(function() {
